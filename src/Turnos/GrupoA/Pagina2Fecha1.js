...
const Pagina2Fecha1 = () => {
    ...
    const handleClickSiguiente = ()=>
    {
        if(vida2 <= 0)
        {
            db.collection('Ganador1GrupoA').add(ganador12)
        }
        else if(vida1 <=0)
        {
            db.collection('Ganador2GrupoA').add(ganador22)
        }
        else
        {
            console.log('siguen');
        ...
        if(vida2 <= 0)
        {
            db.collection('Perdedor1GrupoA').add(perdedor12)
        }
        else if(vida1 <=0)
        {
            db.collection('Perdedor2GrupoA').add(perdedor22)
        }
        else
        {
            console.log('siguen');
