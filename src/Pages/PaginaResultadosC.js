...
const PaginaResultadosC = () => {
    ...
    {
        db.collection('Ganador1GrupoC').where("usuario", "==", usuario.uid).onSnapshot((querySnapshot=>
            {
                const caja = []
    ...
    {
        db.collection('Ganador2GrupoC').where("usuario", "==", usuario.uid).onSnapshot((querySnapshot=>
            {
                const caja = []
                querySnapshot.forEach((element)=>
                {
    ...
    {
        db.collection('Perdedor1GrupoC').where("usuario", "==", usuario.uid).onSnapshot((querySnapshot=>
            {
                const caja = []
                querySnapshot.forEach((element)=>
                {
    ...
    {
        db.collection('Perdedor2GrupoC').where("usuario", "==", usuario.uid).onSnapshot((querySnapshot=>
            {
                const caja = []
                querySnapshot.forEach((element)=>
                {
...
export default PaginaResultadosC
