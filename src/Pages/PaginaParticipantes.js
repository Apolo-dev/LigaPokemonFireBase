...
const PaginaParticipantes = () => {
    ...
    {
        db.collection('GrupoA').where("usuario", "==", usuario.uid).where("bombo", "==", "2").onSnapshot((querySnapshot=>
            {
                const caja = []
                querySnapshot.forEach((element)=>
                {
    ...
    {
        db.collection('GrupoA').where("usuario", "==", usuario.uid).where("bombo", "==", "3").onSnapshot((querySnapshot=>
            {
                const caja = []
                querySnapshot.forEach((element)=>
                {
                        ...
                        <div className="paginacionPaginas">
                            <nav aria-label="Page navigation example">
                                <ul className="pagination">
                                    <li className="page-item"><Link className="page-link" to="dd">Anterior</Link></li>
                                    <li className="page-item"><Link className="page-link" to="/participantes">A</Link></li>
                                    <li className="page-item"><Link className="page-link" to="/participantesB">B</Link></li>
                                    <li className="page-item"><Link className="page-link" to="/participantesC">C</Link></li>
                                    <li className="page-item"><Link className="page-link" to="/participantesD">D</Link></li>
                                    <li className="page-item"><Link className="page-link" to="/participantesE">E</Link></li>
                                    <li className="page-item"><Link className="page-link" to="/participantesF">F</Link></li>
                                    <li className="page-item"><Link className="page-link" to="/participantesG">G</Link></li>
                                    <li className="page-item"><Link className="page-link" to="/participantesH">H</Link></li>
                                    <li className="page-item"><Link className="page-link" to="/participantesB">Siguiente</Link></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
