...
const PaginaParticipantesF = () => {
    ...
    {
        db.collection('GrupoF').where("usuario", "==", usuario.uid).where("bombo", "==", "1").onSnapshot((querySnapshot=>
            {
                const caja = []
                querySnapshot.forEach((element)=>
                {
    ...
    {
        db.collection('GrupoF').where("usuario", "==", usuario.uid).where("bombo", "==", "2").onSnapshot((querySnapshot=>
            {
                const caja = []
                querySnapshot.forEach((element)=>
                {
    ...
    {
        db.collection('GrupoF').where("usuario", "==", usuario.uid).where("bombo", "==", "3").onSnapshot((querySnapshot=>
            {
                const caja = []
                querySnapshot.forEach((element)=>
                {
    ...
    {
        db.collection('GrupoF').where("usuario", "==", usuario.uid).where("bombo", "==", "4").onSnapshot((querySnapshot=>
            {
                const caja = []
                querySnapshot.forEach((element)=>
                {
...
export default PaginaParticipantesF