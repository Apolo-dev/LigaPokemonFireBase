...
const PaginaResultadosB = () => {
    ...
    {
        db.collection('Ganador1GrupoB').where("usuario", "==", usuario.uid).onSnapshot((querySnapshot=>
            {
                const caja = []
    ...
    {
        db.collection('Ganador2GrupoB').where("usuario", "==", usuario.uid).onSnapshot((querySnapshot=>
            {
                const caja = []
                querySnapshot.forEach((element)=>
                {
    ...
    {
        db.collection('Perdedor1GrupoB').where("usuario", "==", usuario.uid).onSnapshot((querySnapshot=>
            {
                const caja = []
                querySnapshot.forEach((element)=>
                {
    ...
    {
        db.collection('Perdedor2GrupoB').where("usuario", "==", usuario.uid).onSnapshot((querySnapshot=>
            {
                const caja = []
                querySnapshot.forEach((element)=>
                {
...
export default PaginaResultadosB